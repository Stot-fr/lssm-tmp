...
export default tsEslint.config(
  eslint.configs.recommended,
  {
    ...
    rules: {
      ...
      'tailwindcss/no-arbitrary-value': 'off', // ['warn', { callees: ['classnames', 'clsx'] }],
  ...
  ...tsEslint.configs.recommendedTypeChecked,
  {
    ...
    languageOptions: {
      ...
      parserOptions: {
        ...
        //       //   './apps/monolith/tsconfig.storybook.json',
        //       //   './apps/server/monolith/tsconfig.json',
        //       //   // './apps/server/default/tsconfig.json',
        //       //   //'./apps/server/medusa/tsconfig.json',
        //       // ],
