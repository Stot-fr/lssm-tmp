...
const Drawer = React.forwardRef(({ className, size = 'sm', anchor = 'left', ...props }, ref) => {
...
const DrawerBackdrop = React.forwardRef(({ className, ...props }, ref) => {
    return (<UIDrawer.Backdrop ref={ref} initial={{
            opacity: 0,
        }} animate={{
            opacity: 0.5,
        }} exit={{
        ...
        }} {...props} className={drawerBackdropStyle({
            class: className,
        })}/>);
});
const DrawerContent = React.forwardRef(({ className, ...props }, ref) => {
    ...
    return (<UIDrawer.Content ref={ref} initial={initialObj} animate={animateObj} exit={exitObj} transition={{
            type: 'timing',
            duration: 300,
        }} {...props} className={drawerContentStyle({
            parentVariants: {
                size: parentSize,
                anchor: parentAnchor,
            },
...
const DrawerHeader = React.forwardRef(({ className, ...props }, ref) => {
    return (<UIDrawer.Header ref={ref} {...props} className={drawerHeaderStyle({
            class: className,
        })}/>);
});
const DrawerBody = React.forwardRef(({ className, ...props }, ref) => {
    return (<UIDrawer.Body ref={ref} {...props} className={drawerBodyStyle({
            class: className,
        })}/>);
});
const DrawerFooter = React.forwardRef(({ className, ...props }, ref) => {
    return (<UIDrawer.Footer ref={ref} {...props} className={drawerFooterStyle({
            class: className,
        })}/>);
});
const DrawerCloseButton = React.forwardRef(({ className, ...props }, ref) => {
    return (<UIDrawer.CloseButton ref={ref} {...props} className={drawerCloseButtonStyle({
            class: className,
        })}/>);
});
