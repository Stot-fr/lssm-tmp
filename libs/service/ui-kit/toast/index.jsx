...
export const ToastTitle = React.forwardRef(({ className, size = 'md', ...props }, _ref) => {
    const { variant: parentVariant, action: parentAction } = useStyleContext(SCOPE);
    return (<UIToast.Title 
    // ref={ref as any}
    {...props} className={toastTitleStyle({
            size,
            class: className,
            parentVariants: {
...
export const ToastDescription = React.forwardRef(({ className, size = 'md', ...props }, _ref) => {
    const { variant: parentVariant } = useStyleContext(SCOPE);
    return (<UIToast.Description 
    // ref={ref as any}
    {...props} className={toastDescriptionStyle({
            size,
            class: className,
            parentVariants: {
                variant: parentVariant,
